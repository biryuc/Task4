...
import Supplier.EngineSupplier;
...
public class MainWindow {
    ...
    public static Configuration conf = new Configuration("conf.txt");
    ...
    private static AccessorySupplier aSup[];
    private static BodySupplier bSup;
    private static EngineSupplier eSup;
    private static Dealer dealer[];

    public static void main(String[] args) {

        int aSupCnt = conf.getParam("AccessorySuppliers");
        aSup = new AccessorySupplier[aSupCnt];
        for (int i=0;i<aSupCnt;i++) {
            aSup[i] = new AccessorySupplier(stockAccessories, 2000, i*10000);
        }

        bSup = new BodySupplier(stockBody, 1000);
        eSup = new EngineSupplier(stockEngine, 500);
